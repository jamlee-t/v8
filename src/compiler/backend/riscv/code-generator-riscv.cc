...
#undef ATOMIC_BINOP_CASE
    ...
    case kRiscvExtMulHighS: {
      ...
      int shift_amount = 128 / sew_bits / 2;
    ...
    case kRiscvBitMask: {
      ...
      __ And(i.OutputRegister(), i.OutputRegister(), Operand(mask));
      break;
    }
    case kRiscvVaddVv: {
      auto sew = DecodeElementWidth(opcode);
